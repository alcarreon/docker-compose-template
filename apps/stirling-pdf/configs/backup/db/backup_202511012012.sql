...
;              
CREATE USER IF NOT EXISTS "SA" SALT '596553943813557d' HASH '910645b9c6b751abc68b3e453acbdb8f356aa15c5ab64d20c52aed29e3d8188e' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, FALSE, '$2a$10$CJJG5Vi.kp/O3up1o4NacOTRQ0GcpvG9UWDLInQczKx6IoGGOYTvy', NULL, 'admin', 1);   
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, '35ef326f-6951-4f1d-af00-17a6e34f7222', 'web', TRUE, FALSE, '$2a$10$Y.gEzysebzg5TkxBQX/k0OuCx/a2EJx126Xo7nNy63c5V7RgcsZwG', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
